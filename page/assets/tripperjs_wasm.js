...
export function get_salt(key) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_salt(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {any}
 */
export function run_x_iterations(iter_n, regex_pattern) {
    const ptr0 = passStringToWasm0(regex_pattern, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_x_iterations(iter_n, ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function run_x_iterations_64(iter_n, regex_pattern) {
    const ptr0 = passStringToWasm0(regex_pattern, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('tripperjs_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
